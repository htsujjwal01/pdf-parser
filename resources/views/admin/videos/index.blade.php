...
<a href="{{ route('admin.videos_approval') }}" class="pull-right btn btn-warning"><span class="badge" style="color: #f0ad4e;">{{$awaitingCount}}</span> Content Awaiting Approval</a>
