 <div class="post_wrapper">
		...
		<h2>{{ $mycity->title }}</h2>
      	...
      	<div class="post_content event_wrapper">
      		...
      		<div class="tribe-events-event-meta vcard">
				<div class="author location">
					...
					<div class="tribe-events-venue-details">
						...
						<a class="tribe-events-gmap" href="#" data-toggle="modal" data-target="#map{{$loop->index}}" title="Click to view a Google Map" >+ Google Map</a>
					</div> 
      		...
      		<div id="map{{$loop->index}}" class="modal fade" role="dialog">
